...
def main(raw_config):
    ...
    # evaluate_to_file(clf, X_val, y_val, help_str=f"Borderline-SMOTE + CatBoost, Dataset:{dataname}", log_file='eval.log')
    ...
    write_avg_results_to_file(
        avg_results,
        help_str=f"Borderline-SMOTE + CatBoost, Dataset:{dataname}",
