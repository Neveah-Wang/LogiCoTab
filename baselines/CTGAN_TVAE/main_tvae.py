...
def train_tvae(
    ...
    print(train_params)
    synthesizer = TVAESynthesizer(**train_params)
...
if __name__ == '__main__':
    ...
    # class Args():
    #     def __init__(self):
    #         self.config = "D:\Study\自学\表格数据生成/v11\exp/adult\TVAE\config.toml"
    #         self.train = True
    #         self.sample = True
    # args = Args()
...
"""
python baselines/CTGAN_TVAE/main_tvae.py --config exp/shopper/TVAE/config.toml --train --sample
python baselines/CTGAN_TVAE/main_tvae.py --config exp/page/TVAE/config.toml --train --sample
python baselines/CTGAN_TVAE/main_tvae.py --config exp/obesity/TVAE/config.toml --train --sample
python baselines/CTGAN_TVAE/main_tvae.py --config exp/buddy/TVAE/config.toml --train --sample
python baselines/CTGAN_TVAE/main_tvae.py --config exp/bean/TVAE/config.toml --train --sample &&
python baselines/CTGAN_TVAE/main_tvae.py --config exp/buddy/TVAE/config.toml --train --sample &&
python baselines/CTGAN_TVAE/main_tvae.py --config exp/magic/TVAE/config.toml --train --sample &&
python baselines/CTGAN_TVAE/main_tvae.py --config exp/churn/TVAE/config.toml --train --sample
"""