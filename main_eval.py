...
if __name__ == '__main__':
    ...
    parser.add_argument('--eval_type', type=str, default='synthetic', choices=["synthetic", "real"], help="The type of data to be evaluated, such as synthetic|real")
    ...
    class Args():
        def __init__(self):
            self.config = "D:\Study\自学\表格数据生成/v11\exp/obesity\GReaT\config.toml"
            self.n_seeds = 5
            self.sampling_method = "GReaT"
            self.eval_type = "synthetic"
